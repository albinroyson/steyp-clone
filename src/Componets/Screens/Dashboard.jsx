...
export default function Dashboard({isClicked,setClicked}) {
    ...
    useEffect(() => {
        axios
        .get('https://learn.steyp.com/api/v1/learn/upcoming-activity/tech-schooling/',
        {
            headers:{
    ...
    const renderItems = ()=>(
        ...
        useEffect(() => {
            axios
            .get('https://learn.steyp.com/api/v1/learn/next-activity/tech-schooling/',
            {
                headers:{
                    Authorization: `Bearer ${access}`,
                },
                    ...
                    <Currentactivitydiv>
                        <Leftcontainer>
                            <Videodiv>
                                ...
                                <Playbutton src={require("../../assests/Img/play (2).svg").default} />
                            </Videodiv>
                        </Leftcontainer>
                        <Rightconainer>
                            <Subhead>
                            ...
                            <Topicname>Backend Developer / django Advanced</Topicname>
                            <Arrowdiv>
                            <Arrow src={require("../../assests/Img/arrow-right.svg").default}/>
                            </Arrowdiv>
                        </Rightconainer>
                    </Currentactivitydiv>
                            {/* ))
                    ...
                    <Videoboxdiv>
                        {
                            topics.map(detail=>(
                                <Videobox>
                                    ...
                                    <Bottomcontent>
                                        <Videoboxcontent>
                                            <TopicnameBottom>{detail.name}</TopicnameBottom>
                                            <Language>{detail.language}</Language>
                                            <Time>4 mins,42 secs</Time>
                                        </Videoboxcontent>
                                        <Lockcontainer>
                                            <Lock src={require("../../assests/Img/lock.svg").default} />
                                        </Lockcontainer>
                                    </Bottomcontent>              
                                </Videobox>
                            ))
